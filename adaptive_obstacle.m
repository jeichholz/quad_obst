function [u2,u1,mesh2]=adaptive_obstacle(ddom,f,phi,u0)
    ...
    for k=active_nodes
        ...
        phi_vals=phi(nodes);
        contact=find(fem_vals<=phi_vals+1e-3);
...
%    [mesh2,qu1]=linear_to_quadratic(mesh2,u1);
    mesh=linear_to_quadratic(mesh2);
    figure;
    d_space_plot(mesh2);
    figure;
  %  [u2,mesh2]=solve_obstacle(mesh2,f,phi,u0,qu1);
